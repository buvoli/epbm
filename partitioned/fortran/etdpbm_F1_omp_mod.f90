...
module etdpbm_F1_omp_mod
    ...
    type etdpbm_F1_omp_settings
        real(dp), allocatable :: z(:)
        real(dp), allocatable :: b(:)
        real(dp)              :: alpha
        integer               :: m
        integer,  allocatable :: mS(:)
    end type etdpbm_F1_omp_settings
    ...
    subroutine etdpbm_F1_omp(L, N, tspan, y_in, Nt, settings, y_out, times)
        ...
        type(etdpbm_F1_omp_settings), intent(in)  :: settings
        ...
        real(dp),    allocatable :: zh(:), bh(:), zh_LN(:)
